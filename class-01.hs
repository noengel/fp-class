...
{-
   ...
   расстановку скобок:
    ...
    x						= <interactive>:25:1: Not in scope: `x'
...
-}
--map :: [Double | Double] -> [String | String]
--map (describeTemperature . f2c) [82, 94, 50, 65, 34]
-- 7) Рекурсия
...
sum_fact :: Int -> Int
sum_fact 1 = 1
sum_fact n = sum_fact (n - 1) + fact n
	where fact f
		| f <= 1 = 1
...
nDays :: Int -> Int
nDays year
	| ( mod year 4 == 0 ) && (( mod year 100 == 0 ) && ( mod year 400 /= 0 )) = 365
	| otherwise = 366
